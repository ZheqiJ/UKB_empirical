...
- rank 2: app_id=100532; score=9.0; grade=candidate; evidence_class=C; components=data_type; repo_path_similarity; title=Statistical methods development for genetic basis of complex traits and predictions; reason=Alternative candidate retained for audit.
  - score_details: `{"data_types": ["genotype", "hospital_episode_statistics"], "evidence_class": "C", "repo_path_tokens": ["predictions"]}`
- rank 3: app_id=217744; score=8.62; grade=candidate; evidence_class=C; components=data_type; repo_path_similarity; title=Developing machine learning (ML) frameworks that can derive multiple phenotypic predictions for risk genotypes at the cell-type level.; reason=Alternative candidate retained for audit.
  - score_details: `{"data_types": ["genotype", "hospital_episode_statistics"], "evidence_class": "C", "repo_path_tokens": ["predictions"]}`
